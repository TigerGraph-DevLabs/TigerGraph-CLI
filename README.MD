...
- [`conf`]  - Configration Manger. Commands that start with `tg conf` allow you to manage configurations used by `tgcli`, including user credentials for TigerGraph Cloud and instances managed by the Box Manager. 
