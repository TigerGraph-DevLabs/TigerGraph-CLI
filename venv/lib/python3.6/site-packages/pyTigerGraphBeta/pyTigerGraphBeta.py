...
class TigerGraphConnection(object):
    ...
    def uploadFile(self, filePath, fileTag, jobName="", timeout=16000, sizeLimit=128000000, attributes=None):
        ...
        return self._post(self.restppUrl + "/ddl/" + self.graphname, params=params, data=data,headers={"RESPONSE-LIMIT": str(sizeLimit), "GSQL-TIMEOUT": str(timeout)})  #[0]["accepted_edges"]
